...
Config.Languages = {
    ...
    ['es'] = { -- Spanish
        ...
        ['favoriteinfo'] = "Selecciona un emoticono aquí para configurarlo como tu favorito.",
        ['rfavorite'] = "Reestablecer favorito",
        ['prop2info'] = "❓ Prop Emotes se pueden ubicar al final",
        ['set'] = "Elegir (",
        ['setboundemote'] = ") como tu animación favorita?",
        ['newsetemote'] = "~w~ es ahora tu animación favorita, pulsa ~g~[BLOQ. MAYÚS]~w~ para usarla.",
        ...
        ['infoupdateav'] = "Sugerencias y reportar bugs/duplicados",
        ['infoupdateavtext'] = "Para pedir animaciones o reportar bugs/duplicados, por favor abre tícket en Discord.",
        ['suggestions'] = "Sugerencias?",
        ['suggestionsinfo'] = "TayMcKenzieNZ' en el foro de FiveM para cualquier sugerencia! ✉️",
        ['notvaliddance'] = "no es un baile válido.",
        ['notvalidemote'] = "no es una animacion válida.",
        ...
        ['pee'] = "Mantén pulsada ~y~G~w~ para mear.",
        ['spraychamp'] = "Mantén pulsada ~y~G~w~ rociar champán.",
        ['bound'] = "Unida ",
        ['to'] = "a",
        ['currentlyboundemotes'] = " Emotes vinculados actualmente:",
        ['notvalidkey'] = "no es una clave válida.",
        ['keybinds'] = "🔢 Bindeos de teclas",
